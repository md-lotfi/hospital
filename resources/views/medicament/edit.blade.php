            ...
            <div class="col-md-4 offset-md-4">
                <form action="{{ url('medicament/update') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$medic->dose_medic}}" id="prenom" name="prenom" placeholder="Ajouter une dose">
                        <small class="form-text text-muted">Saisisser une dose</small>
                    </div>
                    <input type="hidden" name="id_inf" value="{{ $medic->id_medic }}" />
